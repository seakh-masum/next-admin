...
const ThemePicker = () => {
  ...
  const ThemePickerStyle = {
    ColorBox: 'grid grid-cols-3 p-3 gap-3',
  ...
  return (
    // <DialogContext.Provider value={{ isDialogOpen: true, dialogTitle: 'Theme Picker' }}>
    <div className="flex flex-col p-6 bg-white dark:bg-neutral-700 w-[500px]">
